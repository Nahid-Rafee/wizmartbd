                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <button class="btn col-auto btn-icon btn-sm fs-15" type="button" data-type="plus" data-field="qty-{{ $key }}">
                                    ...
                                    <input type="number" class="form-control px-0 text-center" name="cart_quantity" placeholder="1" id="qty-{{ $key }}" value="{{ $cartItem['quantity'] }}" onchange="updateQuantity({{ $key }})" min="1">
                            ...
                            <td class="text-right">
                                <button type="button" class="btn btn-circle btn-icon btn-sm btn-danger" onclick="removeFromCart({{ $key }},{{$cartItem['quantity']}})"><i class="las la-trash-alt"></i></button>
                            </td>
                        </tr>
                    @empty
                        <tr>
